...
let g:clever_f_any_signs_match_signs   = get(g:, 'clever_f_any_signs_match_signs', '')
...
function! s:get_any_sign_regex()
    if g:clever_f_any_signs_match_signs ==# ''
        return '\[!"#$%&''()=~|\-^\\@`[\]{};:+*<>,.?_/]'
    endif

    return '\[' . escape(g:clever_f_any_signs_match_signs, ']') . ']'
endfunction
